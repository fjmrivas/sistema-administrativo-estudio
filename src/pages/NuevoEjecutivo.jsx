...
export default function NuevoEjecutivo() {
    ...
    return (
      <div>
        <h2 className="mb-6 text-xl font-semibold text-navy">
          {editando ? 'Editar Ejecutivo' : 'Nuevo Ejecutivo'}
        </h2>
  ...
  async function handleSubmit(e) {
    ...
    const { error: err } = editando
      ? await supabase.from('ejecutivos').update(payload).eq('id', id)
